...
class Header extends HTMLElement {
  ...
  setUpEventListener(){
    const helpBtn = this.querySelector("#helpBtn");
    const helpDropdown = this.querySelector("#helpDropdown");
    ...
    helpBtn.addEventListener("mouseover", handleMouseOver);
    helpDropdown.addEventListener("mouseover", handleMouseOver);
    helpBtn.addEventListener("mouseout", handleMouseOut);
    helpDropdown.addEventListener("mouseout", handleMouseOut);
  }
}
