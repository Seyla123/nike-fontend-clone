...
export function createClassicCarousel (arr,componentName=false){
    class CarouselClassic extends HTMLElement {
        constructor(){
            super()
        }
        connectedCallback(){
            this.innerHTML = createCarouselClassic(arr);
    ...
    customElements.define(componentName ? componentName:"classic-carousel", CarouselClassic)
}