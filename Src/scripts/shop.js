...
nikeData = {
  ...
  //category  brand_name  color  gender grid_picture_url id main_picture_url name original_picture_url story_html
shopNike = {
  "sneakers": [
    {
...
//   for (const key in nikeData) {
//     document.body.innerHTML += `${key}:</br>`;
//     console.log("name " + nikeData[key]['name'])
//     console.log("Price " + nikeData[key]['price'])
//     for (const value in nikeData[key]){
//       document.body.innerHTML+=`${value} : ${nikeData[key][value]}</br>`

//     }
// }
console.log(shopNike.color)
// for (const key in nikeData) {
//   document.body.innerHTML += `${key}:</br>`;
//   console.log("name " + nikeData[key]['name'])
//   console.log("Price " + nikeData[key]['price'])
...
{/* <div class="">
                <div>
                    <img src="https://static.nike.com/a/images/c_limit,w_592,f_auto/t_product_v1/u_126ab356-44d8-4a06-89b4-fcdcc8df0245,c_scale,fl_relative,w_1.0,h_1.0,fl_layer_apply/312b0732-3206-40fa-b578-7bfb62c0675a/air-jordan-1-retro-high-og-mens-shoes-JHpxkn.png" alt="">
                </div>
                <div class="py-2 flex flex-col gap-1">
                    <p class="text-red-800">Just In</p>
                    <p class="font-medium">Air Jordan 1 Retro High OG</p>
                    <p class="text-gray-400">Men Shoe</p>
                    <p class="text-gray-400">1 Color</p>
...
for (i=0; i<30;i++){
  ...
  <div class="bg-gray-100">
      <img src="${shopNike.sneakers[i]["main_picture_url"]}" alt="">
  </div>
  <div class="py-2 flex flex-col gap-1">
      <p class="text-red-800">Just In</p>
      <p class="font-medium">${shopNike.sneakers[i]["name"]}</p>
      <p class="text-gray-400">Men Shoe</p>
      <p class="text-gray-400">1 Color</p>
      <p class="font-medium">$${shopNike.sneakers[i]["retail_price_cents"]/100}</p>
  </div>
</a>`
}