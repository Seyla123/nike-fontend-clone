const createMenu = ()=>{
    return `<div id="menu" class="w-full flex justify-between py-6 duration-300 sticky top-0 z-30   bg-white flex-col md:flex-row">
    <div class="flex-1 flex items-center py-4">
        <h3 class="text-2xl duration-500 hal-font hal-font">New Release <span class="opacity-0 lg:opacity-100">(1890)</span></h3>
    </div>
            ...
            <div id="sortByDropdown" class="bg-white hidden rounded-lg right-0 top-10 duration-300  absolute z-50 ">
                <div class=" p-4 space-y-4">
                  <ul class="text-base space-y-1 hal-font text-end">
                    <li >
                        <a class="hover:text-gray-500" href="">Featured</a>
                    </li>
                    <li>
                        <a class="hover:text-gray-500" href="">Newest</a>
                    </li>
                    <li>
                        <a class="hover:text-gray-500" href="">Price : Hight-Low</a>
                    </li>
                    <li>
                        <a class="hover:text-gray-500" href="">Price : Low-Hight</a>
                    </li>
                  </ul>
                </div>
              </div>
